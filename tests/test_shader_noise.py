...
@pytest.mark.parametrize("shader_type", ["domain_warp", "tensor_field", "curl_noise", "temporal_coherent",
                                         "gaussian", "fractal", "perlin", "heterogeneous_fbm", "interference"])
...
@pytest.mark.parametrize("shader_type", ["domain_warp", "curl_noise", "temporal_coherent", "gaussian", "fractal", "perlin", "heterogeneous_fbm", "interference"])
