...
> [!IMPORTANT]
>The Shader Noise KSampler contains a shader display and requires saving, while the Shader Noise Ksampler (Direct) does not contain a shader display and does not require saving
> [!TIP]
