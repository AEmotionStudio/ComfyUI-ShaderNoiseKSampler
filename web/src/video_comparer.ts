...
function drawGoldenEyeball(ctx: CanvasRenderingContext2D, centerX: number, centerY: number, size: number, shimmerPosition: number): void {
    const eyeWidth = size * 1.6, eyeHeight = size * 1.0;
    const irisRadius = size * 0.35, pupilRadius = size * 0.15;
    ...
    // Draw rays shadows
    const rayCount = 6, rayLength = size * 0.7;
...
function drawGradientTitle(node: LGraphNode, ctx: CanvasRenderingContext2D): void {
